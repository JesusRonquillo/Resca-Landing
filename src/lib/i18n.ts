...
export const messages: Record<Locale, Messages> = {
  en: {
    ...
    hero: {
      ...
      inKindLabel: "In-kind, community-chosen",
      countriesValue: "Peru & Bolivia",
      highlandLabel: "Highland communities",
    },
    stats: [
      { label: "Varieties conserved", hint: "threatened native crops" },
      { label: "Key crops", hint: "quinoa, amaranth, potato & Andean tubers" },
      { label: "Farmers rewarded", hint: "40% of them women" },
      { label: "Communities", hint: "across Latin America" },
    ],
    mission: {
    ...
    footer: {
      ...
      working: "Working with highland communities across Peru & Bolivia.",
  ...
  es: {
    ...
    hero: {
      ...
      titlePost: ".",
      subtitle:
        "RESCA recompensa a las familias andinas por conservar variedades de quinua amenazadas, convirtiendo la biodiversidad en dignidad, resiliencia y patrimonio vivo en Perú y Bolivia.",
      donate: "Donar ahora",
      learn: "Cómo funciona",
      farmersLabel: "Agricultores recompensados",
      inKindLabel: "En especie, elegido por la comunidad",
      countriesValue: "Perú y Bolivia",
      highlandLabel: "Comunidades altoandinas",
    },
    stats: [
      ...
      { label: "Agricultores recompensados", hint: "40% de ellas mujeres" },
      { label: "Comunidades", hint: "en toda América Latina" },
    ],
    mission: {
      ...
      badgeTitle: "Puno · Potosí · Oruro",
      badgeBody:
        "Comunidades altoandinas donde la siembra comienza con las lluvias de septiembre.",
    },
    cycle: {
    ...
    donate: {
      ...
      checklist: [
        ...
        "Cada aporte mantiene viva una variedad",
      ],
      secure: {
    ...
    footer: {
      ...
      working: "Trabajamos con comunidades altoandinas en Perú y Bolivia.",
