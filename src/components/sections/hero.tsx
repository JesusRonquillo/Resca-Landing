    ...
    >
      ...
      {!reduce && (
        <motion.div style={{ y: floatY }} className="pointer-events-none absolute inset-0 -z-10">
          <img
            ...
            alt=""
            aria-hidden
            className="animate-float-slow absolute right-[6%] top-[16%] hidden w-40 opacity-90 drop-shadow-2xl md:block md:w-56 lg:w-64"
          />
      ...
      >
        <motion.div variants={container} initial="hidden" animate="show" className="max-w-3xl">
          ...
          >
            Reward the farmers who keep our{" "}
            <span className="text-gradient-quinoa">rarest seeds</span> alive.
          </motion.h1>
          ...
          >
            RESCA pays Andean families for conserving endangered quinoa varieties —
            turning biodiversity into dignity, resilience and living heritage across
            Peru and Bolivia.
          </motion.p>
          ...
          >
            <div>
              ...
              <dd className="text-sm text-muted">Farmers rewarded</dd>
            </div>
            <div className="hidden h-10 w-px bg-border sm:block" />
            <div>
              <dt className="font-display text-3xl font-extrabold text-text">100%</dt>
              <dd className="text-sm text-muted">In-kind, community-chosen</dd>
            </div>
            <div className="hidden h-10 w-px bg-border sm:block" />
            <div>
              <dt className="flex items-center gap-1 font-display text-3xl font-extrabold text-text">
                <MapPin size={22} className="text-primary" /> Peru &amp; Bolivia
              </dt>
              <dd className="text-sm text-muted">Highland communities</dd>
            </div>
          </motion.dl>
        </motion.div>
      </motion.div>
