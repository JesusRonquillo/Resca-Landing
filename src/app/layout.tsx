    ...
    >
      <body className="min-h-full flex flex-col bg-bg text-text">
        {/* Preload the LCP hero image (AVIF) — must match ResponsiveImage's
            srcset (ASSET_VERSION=5) so the browser reuses the same download. */}
        <link
          rel="preload"
          as="image"
          type="image/avif"
          imageSrcSet="/images/hero-field-480.avif?v=5 480w, /images/hero-field-960.avif?v=5 960w, /images/hero-field-1600.avif?v=5 1600w"
          imageSizes="100vw"
          fetchPriority="high"
        />
        <ThemeProvider
